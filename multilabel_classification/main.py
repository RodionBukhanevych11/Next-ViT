...
def get_args_parser():
    ...
    parser.add_argument('--balance-classess', type=bool, default=True)
...
def main(args):
    ...
    if args.eval:
        ...
        f1_per_class = evaluate(data_loader_val, model, device, config)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        f1, val_loss = evaluate(data_loader_val, model, device, config)
